...
@Component({
  ...
  template: `
    <div class="relative">
      <img src="../../assets/images/hero.jpg" alt="Background Image" class="w-full h-auto object-cover" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center">
        ...
        <form [formGroup]="emailForm" (ngSubmit)="onSubmit()" class="flex mt-4 flex-col sm:flex-row">
          <div class="relative">
            <input
